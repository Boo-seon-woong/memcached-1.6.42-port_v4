...
GET-only 7.245   9.474  11.926  12.354  11.816  M
  span   25.84   26.37   26.97   26.55   26.42
혼합     6.426   7.774   9.774  10.049   8.746  M
  Gspan  21.98   22.87   21.03   20.71   23.49
  Sspan  10.47   10.46    9.28    8.63    8.41
```
...
두 워크로드 다 `pipe=256` 이 꼭짓점이고 384 는 퇴행한다.
(이 표는 MEMSET 이전 빌드다 — 절대값은 §최종 게이트가 최신이다.)
