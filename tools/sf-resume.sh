...
# ── 재개 지점: E 축 완료 대기 (P·E 는 이미 GO 가 나가 genie 가 돌고 있다) ──
say "E 축 완료 대기 (SF3-E128x8-SET)"
MATCH=SF3-E128x8-SET TIMEOUT=10800 tools/night-cell.sh wait || say "E 대기 타임아웃 — 그래도 D 로 간다 (서버는 OP 무장 그대로)"
sfsave
say "D 축부터 재개"
